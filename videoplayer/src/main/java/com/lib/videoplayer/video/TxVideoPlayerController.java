package com.lib.videoplayer.video;
...
import com.lib.videoplayer.bean.Clarity;
import com.lib.videoplayer.ui.ChangeClarityDialog;
...
public class TxVideoPlayerController
    ...
    public void setLenght(long length) {
        mLength.setText(Util.formatTime(length));
    }
    ...
    protected void onPlayStateChanged(int playState) {
        switch (playState) {
            ...
            case VideoPlayer.STATE_COMPLETED:
                ...
                mImage.setImageBitmap(Util.getVideoThumbnail(mNiceVideoPlayer.getVideoUrl(),mNiceVideoPlayer.getDuration()));
    ...
    protected void showChangePosition(long duration, int newPositionProgress) {
        ...
        mChangePositionCurrent.setText(Util.formatTime(newPosition));
        mChangePositionProgress.setProgress(newPositionProgress);
        mSeek.setProgress(newPositionProgress);
        mPosition.setText(Util.formatTime(newPosition));
    }
