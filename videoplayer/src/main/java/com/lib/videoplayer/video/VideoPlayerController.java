...
public abstract class VideoPlayerController
    ...
    protected IVideoPlayer mNiceVideoPlayer;
                ...
                if (!mNeedChangePosition && !mNeedChangeVolume && !mNeedChangeBrightness) {
                    ...
                    if (absDeltaX >= THRESHOLD) {
                        ...
                        if (mDownX < getWidth() * 0.5f) {
                            ...
                            //解决首次上滑变暗
                            if (mGestureDownBrightness <= 0.00f) {
                                mGestureDownBrightness = 0.40f;
                            } else if (mGestureDownBrightness < 0.01f) {
                                mGestureDownBrightness = 0.01f;
                            }
                        } else {
                            // 右侧改变声音
